	...
	$(function() {
		...
		$("button").click(function() {
		    if(this.id=="save"){
		    	...
		    	this.action = "${pageContext.request.contextPath}/userTypes/cancel"
		    		$('#updateForm').attr("action", "${pageContext.request.contextPath}/userTypes/cancel");
		    		return true;
		    }
		});
...
<div id="page">
	...
	<form:form id="updateForm" class="form-horizontal" action="save" method="post"
		commandName="userTypeForm">
		<fieldset>

			<!-- Form Name -->
			<legend>Update User Type</legend>

			<!-- Text input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="usertype">User Type</label>
				<div class="col-md-4">
					<form:input path="userType" id="userType" type="text"
